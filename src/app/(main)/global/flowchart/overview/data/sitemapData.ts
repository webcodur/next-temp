...
export const sitemapData: NodeSitemapData[] = [
	{
		...
		title: '주차장 관리',
		description:
			'주차장 시설과 차량 출입을 종합적으로 관리하는 핵심 기능들입니다.',
		categories: [
			{
				name: '주차장 관리',
				...
				pages: [
					{
						...
						detailTabs: [
							{
								name: '기본 정보',
								description: '차단기 위치, 모델, 상태 등 기본 정보',
							},
							{
								name: '출입 권한',
								description: '차단기별 차량 출입 권한 설정',
							},
	...
	},
	{
		...
		categories: [
			{
				name: '입주 관리',
				description: '세대별 입주 현황과 관련 서비스를 관리합니다.',
				pages: [
					{
						name: '세대 관리',
						href: '/parking/occupancy/instance',
						description: '세대별 기본 정보와 입주 상태를 관리합니다.',
						detailTabs: [
							{
								name: '기본 정보',
								description: '세대 위치, 면적, 타입 등 기본 정보',
							},
							{
								name: '서비스 설정',
								description: '세대별 제공 서비스와 권한 설정',
							},
							{
								name: '방문 설정',
								description: '방문자 출입 규칙과 제한 사항 설정',
							},
						],
					},
				],
	...
	},
	{
		nodeId: 'person',
		title: '주민 관리',
		description: '실제 거주하는 주민의 정보와 거주 이력을 관리합니다.',
		categories: [
			{
				name: '입주 관리',
				description: '주민의 개인정보와 거주 관련 사항을 관리합니다.',
				pages: [
					{
						name: '주민 관리',
						...
						detailTabs: [
							...
							{
								name: '거주 정보',
								description: '현재 거주 세대과 계약 상태 정보',
							},
							{ name: '이동 이력', description: '세대 변경과 이사 내역 추적' },
						],
					},
				],
			},
	...
	},
	{
		nodeId: 'vehicle',
		title: '차량 관리',
		description: '주민 소유 차량의 등록 정보와 연결 관계를 관리합니다.',
		categories: [
			{
				name: '입주 관리',
				description: '주민 차량의 등록과 연결 관계를 관리합니다.',
				pages: [
					{
						name: '차량 관리',
						href: '/parking/occupancy/car',
						description: '주민 소유 차량의 등록 정보를 관리합니다.',
						detailTabs: [
							{
								name: '기본 정보',
								description: '차량 번호, 모델, 색상 등 기본 정보',
							},
							{
								name: '세대 연결',
...
// #region 헬퍼 함수
export const getSitemapDataByNodeId = (
	nodeId: string
): NodeSitemapData | undefined => {
