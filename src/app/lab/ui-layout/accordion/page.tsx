	...
	return (
		<div className="p-8 min-h-screen bg-background">
			<div className="mx-auto max-w-4xl">
				<div className="mb-8">
					<h1 className="mb-4 text-3xl font-bold text-foreground">Accordion 컴포넌트</h1>
					<p className="text-muted-foreground">접기/펼치기 기능을 제공하는 아코디언 컴포넌트 테스트</p>
				</div>
						...
						>
							<div className="space-y-3">
								...
								<div className="flex gap-3 items-center">
									...
									<label htmlFor="option3" className="text-sm text-foreground">
										옵션 3 활성화
									</label>
								</div>
							</div>
