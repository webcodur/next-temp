        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <Card>
              ...
              <CardFooter>
                <p className="text-sm text-muted-foreground">최종 업데이트: 2023년 6월</p>
              </CardFooter>
            </Card>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <Card hoverEffect>
              <CardHeader>
                ...
                <CardDescription>마우스를 올리면 효과가 나타납니다.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <Card className="relative">
              <CardHeader>
                ...
                <CardDescription>우측 상단에 액션 버튼이 있습니다.</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="relative group" hoverEffect>
              <CardHeader>
                ...
                <CardDescription>마우스를 올리면 액션 버튼이 나타납니다.</CardDescription>
              </CardHeader>
              <CardContent>
