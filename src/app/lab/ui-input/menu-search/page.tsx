  ...
  return (
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-6 bg-card border border-border rounded-lg">
          <h3 className="text-lg font-semibold text-foreground mb-2">계층 표시</h3>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="p-6 bg-card border border-border rounded-lg">
          <h3 className="text-lg font-semibold text-foreground mb-2">빠른 이동</h3>
          <p className="text-sm text-muted-foreground">
      ...
      {/* 마지막 선택 결과 */}
      {lastSelection && (
        <div className="p-6 bg-primary-0 border border-primary rounded-lg">
          <h3 className="text-lg font-semibold text-foreground mb-2">마지막 선택 결과</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-counter-1 rounded-lg">
            <h4 className="font-medium text-foreground mb-2">추천 검색어</h4>
            <div className="flex flex-wrap gap-2">
              {['주차', '관리', '설정', '규정', '위반', '블랙리스트', '호실', '입주자', '차량', '캐시', 'IP'].map((keyword) => (
                <span key={keyword} className="px-2 py-1 bg-background text-foreground text-xs rounded border">
                  {keyword}
                </span>
              ))}
            </div>
          ...
          <div className="p-4 bg-counter-1 rounded-lg">
            <h4 className="font-medium text-foreground mb-2">검색 팁</h4>
