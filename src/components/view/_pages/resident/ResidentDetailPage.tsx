...
import ResidentInstanceSection from '@/components/view/_pages/resident/ResidentInstanceSection';
import ResidentHistorySection from '@/components/view/_pages/resident/ResidentHistorySection';
