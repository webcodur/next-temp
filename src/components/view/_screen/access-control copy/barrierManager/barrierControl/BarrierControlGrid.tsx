/* 
  파일명: BarrierControlGrid.tsx
  기능: 차단기 개폐 제어 그리드 컴포넌트 (컨트롤러 방식)
...
import BarrierControlCard from './BarrierControlCard';
...
export default BarrierControlGrid;
// #endregion