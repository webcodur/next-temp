...
import HouseholdInfoForm from './householdDetail/components/HouseholdInfoForm';
import { HouseholdFormData } from './householdDetail/types';
...
export default function HouseholdCreateView() {
  // #region 상태 관리
