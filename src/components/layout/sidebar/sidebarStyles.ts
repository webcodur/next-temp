...
export const toggleButtonBase =
	'flex justify-center items-center bg-background transition-all duration-300 cursor-pointer group';
...
export const toggleButtonIcon =
	'w-4 h-4 transition-all duration-200 text-muted-foreground group-hover:text-primary group-hover:scale-110';
