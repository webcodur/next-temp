...
// #region 기본 타입
export interface SortableTableColumn<T = Record<string, unknown>> extends BaseTableColumn<T> {
...
export interface SortableRowProps<T extends Record<string, unknown>> {
  item: T;
  index: number;
  columns: SortableTableColumn<T>[];
