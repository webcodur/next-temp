/*
  파일명: src/components/ui/system-testing/rtl-demo/rtl-demo.example.tsx
  기능: RTL(Right-to-Left) 언어 지원을 테스트하는 데모 예제
...
export default function RTLDemoExample() {
	// #region 훅 및 상태
