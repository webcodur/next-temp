/*
  파일명: src/components/ui/ui-3d/threejs-basics/threejs-basics.example.tsx
  기능: Three.js의 가장 기본적인 3요소(Scene, Camera, Renderer)를 사용하여 3D 렌더링의 핵심 원리를 시연하는 예제
...
export default function ThreejsBasicsExample() {
	// #region 훅 및 참조
