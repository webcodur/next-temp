/*
  파일명: src/components/ui/ui-3d/threejs-geometries/threejs-geometries.example.tsx
  기능: Three.js에서 제공하는 다양한 기본 도형(Geometries)을 시각적으로 보여주는 예제
...
export default function ThreejsGeometriesExample() {
	// #region 훅 및 참조
