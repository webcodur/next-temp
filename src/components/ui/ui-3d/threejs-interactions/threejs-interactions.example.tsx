/*
  파일명: src/components/ui/ui-3d/threejs-interactions/threejs-interactions.example.tsx
  기능: Three.js에서의 사용자 상호작용(궤도 제어, 드래그, 클릭 등)을 시연하기 위한 예제
