/*
  파일명: src/components/ui/ui-3d/threejs-advanced/threejs-advanced.example.tsx
  기능: Three.js의 고급 기능(텍스처, 파티클, 그림자 등)을 시연하는 예제
...
export default function ThreejsAdvancedExample() {
	// #region 훅 및 참조
