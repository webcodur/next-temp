/*
  파일명: src/components/ui/ui-3d/threejs-animations/threejs-animations.example.tsx
  기능: Three.js를 사용한 기본적인 3D 애니메이션(회전, 이동, 크기/색상 변경)을 시연하는 예제
...
export default function ThreejsAnimationsExample() {
	// #region 훅 및 참조
	...
	// #region Three.js 씬 초기화 및 애니메이션 루프
	useEffect(() => {
