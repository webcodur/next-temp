  ...
  return (
    <div className={`${CONTAINER_STYLES.main} ${className}`}>
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-3 gap-3 items-center">
          <div className={LABEL_BOX_STYLES}>
            <label className="text-sm font-medium text-foreground">주소 입력</label>
          </div>
          <div className="relative col-span-2 h-14">
            ...
            <input
              ...
              disabled={disabled}
              className={`
                w-full pl-9 pr-9 h-full text-base rounded-lg border transition-colors
                ${disabled 
        ...
        {/* 미리보기 - 고정 높이 */}
        <div className="p-3 rounded-lg border bg-muted/30 border-border/50" style={{ minHeight: '80px' }}>
          {hasAddress ? (
            ...
            <div className="flex justify-center items-center h-full text-sm text-muted-foreground" style={{ minHeight: '56px' }}>
