	...
	'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-multilang font-medium transition-all duration-150 ease-in-out focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer',
	{
		variants: {
			variant: {
				...
				'outline-primary': 'neu-flat border border-primary/50 bg-background text-primary hover:bg-primary/10',
				'outline-secondary': 'neu-flat border border-secondary/50 bg-background text-secondary hover:bg-secondary/10',
				'primary-secondary': 'neu-raised bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:scale-[1.02] hover:from-primary-hover hover:to-secondary-hover',
