				...
				<div className="absolute top-0 bottom-0 flex justify-center w-2 left-5">
					<div
						...
						style={{
							...
							boxShadow: `
								inset 2px 0 4px rgba(var(--neu-dark)),
								inset -2px 0 4px rgba(var(--neu-light)),
								inset 0 2px 2px rgba(var(--neu-dark))
							`,
						}}
					/>
				</div>
						...
						<div className="absolute top-2 -left-8">
							<div
								...
								style={{
									...
									boxShadow: `
										2px 2px 4px rgba(var(--neu-dark)),
										-1px -1px 3px rgba(var(--neu-light)),
										inset 1px 1px 2px rgba(var(--neu-light)),
										inset -1px -1px 2px rgba(var(--neu-dark))
									`,
								}}>
								{/* 중앙 액센트 점 */}
								<div
									...
									style={{
										...
										boxShadow: 'inset 0 0 2px rgba(var(--neu-dark))',
									}}
								/>
							</div>
						</div>
