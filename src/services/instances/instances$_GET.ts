...
// #region 변환 함수 (내부 사용)
function convertInstanceServiceConfig(server: InstanceServiceConfigServer): InstanceServiceConfig {
  return {
    id: server.id,
...
function convertInstanceVisitConfig(server: InstanceVisitConfigServer): InstanceVisitConfig {
  return {
    id: server.id,
    instanceId: server.instance_id,
...
function convertResidentInstance(server: ResidentInstanceServer): ResidentInstanceWithResident {
  return {
    id: server.id,
