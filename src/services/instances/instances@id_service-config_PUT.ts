...
// #region 변환 함수 (내부 사용)
function clientToServer(client: UpdateInstanceServiceConfigRequest): UpdateInstanceServiceConfigServerRequest {
  return {
...
export async function updateInstanceServiceConfig(id: number, data: UpdateInstanceServiceConfigRequest) {
