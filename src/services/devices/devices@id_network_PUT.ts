...
function clientToServer(
	client: UpdateParkingDeviceNetworkRequest
): UpdateParkingDeviceNetworkServerRequest {
	return {
		ip: client.ip,
		port: client.port,
...
export async function updateParkingDeviceNetwork(
	id: number,
	data: UpdateParkingDeviceNetworkRequest
) {
