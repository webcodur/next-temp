...
import { SearchParkingDeviceCommandLogRequest, ParkingDeviceCommandLogListResponse, ParkingDeviceCommandLog } from '@/types/device';
...
// #region 변환 함수 (내부 사용)
function serverToClient(server: ParkingDeviceCommandLogServerResponse): ParkingDeviceCommandLog {
  return {
    id: server.id,
...
function serverListToClient(serverResponse: ParkingDeviceCommandLogListServerResponse): ParkingDeviceCommandLogListResponse {
  return {
...
export async function searchParkingDeviceCommandLogs(id: number, params?: SearchParkingDeviceCommandLogRequest) {
