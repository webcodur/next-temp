...
function clientToServer(
	client: UpdateParkingDeviceStatusRequest
): UpdateParkingDeviceStatusServerRequest {
	return {
...
export async function updateParkingDeviceStatus(
	id: number,
	data: UpdateParkingDeviceStatusRequest
) {
