...
import { UpdateParkingDeviceBasicInfoRequest, ParkingDevice } from '@/types/device';
...
// #region 변환 함수 (내부 사용)
function clientToServer(client: UpdateParkingDeviceBasicInfoRequest): UpdateParkingDeviceBasicInfoServerRequest {
  return {
    name: client.name,
...
export async function updateParkingDeviceBasicInfo(id: number, data: UpdateParkingDeviceBasicInfoRequest) {
