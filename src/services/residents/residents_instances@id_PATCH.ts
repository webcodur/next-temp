...
import { UpdateResidentInstanceRequest, ResidentDetail } from '@/types/resident';

// #region 서버 타입 정의 (내부 사용)
interface UpdateResidentInstanceServerRequest {
  memo?: string;
}
...
// #region 변환 함수 (내부 사용)
function clientToServer(client: UpdateResidentInstanceRequest): UpdateResidentInstanceServerRequest {
  return {
    memo: client.memo,
  };
}
...
export async function updateResidentInstance(id: number, data: UpdateResidentInstanceRequest) {
