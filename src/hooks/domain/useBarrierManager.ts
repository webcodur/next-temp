/* 
  파일명: /hooks/domain/useBarrierManager.ts
  기능: 차단기 관리 시스템 통합 상태 관리 훅
...
interface UseBarrierManagerProps {
...
interface UseBarrierManagerReturn {
	// 상태
...
// #region 메인 훅
export const useBarrierManager = ({
	initialBarriers,
	onBarrierOpen,
	onBarrierClose,
	onOperationModeChange,
}: UseBarrierManagerProps): UseBarrierManagerReturn => {
	// #region 상태
