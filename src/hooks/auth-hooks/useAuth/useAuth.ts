...
import {
	...
	userProfileAtom,
	parkingLotsAtom,
	selectedParkingLotIdAtom,
	manualParkingLotIdAtom,
} from '@/store/auth';
...
export function useAuth() {
	...
	const [tokenSelectedParkingLotId, setTokenSelectedParkingLotId] = useAtom(
		selectedParkingLotIdAtom
	);
	const [manualSelectedParkingLotId, setManualSelectedParkingLotId] = useAtom(
		manualParkingLotIdAtom
	);
	...
	const { parkingLots, selectedParkingLot, selectParkingLot } =
		useParkingLotManagement();
	...
	const effectiveSelectedParkingLotId =
		tokenSelectedParkingLotId === 0
